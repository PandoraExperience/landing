    ...
    <div className={cn("relative", className)}>
      ...
      >
        <img
          ...
          width={1920}
          height={1080}
          className="w-full h-[280px] md:h-[400px] object-contain bg-gray-900 transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-md shadow-lg border"
        />
