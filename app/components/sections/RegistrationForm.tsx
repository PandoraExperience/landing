        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="bg-[#111111] rounded-xl p-8">
            ...
            <div className="mt-6 pt-6 border-t border-white/5">
              <button
                onClick={() => {
                  const message = encodeURIComponent('Hola! Me interesa el pago en 2 cuotas para la experiencia PANDORA. ¿Podrían ayudarme con el proceso?');
                  window.open(`https://wa.me/573127811615?text=${message}`, '_blank', 'noopener,noreferrer');
                }}
