          ...
          <nav className="hidden md:flex justify-center space-x-4">
            {[
              ...
              >
                {item.label}
                <span 
                  className={`absolute -bottom-1 left-0 h-0.5 bg-primary transition-all duration-300 origin-left ${
                    activeSection === item.id
                      ? 'w-full'
                ...
                <span 
                  className={`absolute inset-0 bg-primary/0 group-hover:bg-primary/5 rounded-lg -z-10 transition-all duration-300 ${
            ...
            <nav className="flex flex-col space-y-4 mb-12">
              {[
                ...
                >
                  ...
                  <span 
                    className={`absolute inset-0 transform scale-x-0 origin-left bg-gradient-to-r from-primary/10 to-transparent transition-transform duration-300 ease-out ${
